...
class PotholeInspectionBT:
    def __init__(self):
        ...
        # pothole offset
        at_pothole_offset = base.AtGPS(
            "At pothole offset GPS?", self.pothole_offset_gps
        )
        go_to_pothole_offset = base.GoToGPS(
            "Go to pothole offset", self.pothole_offset_gps
        )
        ...
        inspection_mode = pt.composites.Sequence(
            ...
            memory=True,
            children=[inspection_loop, send_pothole_to_kakfa],
        )
