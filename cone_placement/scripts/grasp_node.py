...
class GraspExecutionAction(object):
    ...
    def load_parameters(self):
        ...
        self.base_frame = rospy.get_param("heron_demo/base_frame_id", "base_footprint")
        self.velocity_scaling = rospy.get_param("heron_demo/arm_velocity_scaling_grasp", 0.2)
        self.ee_grasp_offset_z = rospy.get_param("heron_demo/ee_grasp_offset_z", -0.04)

    def execute_cb(self, goal: Pose):
        ...
        self.moveit_target_pub.publish(to_pose_stamped_msg(target, self.base_frame))
        self.moveit.go_to_pose_goal_cartesian(target, self.velocity_scaling)
